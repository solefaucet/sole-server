...
CREATE TABLE `users` (
  ...
  `balance` DECIMAL(19, 8) NOT NULL DEFAULT 0 COMMENT 'user account balance count',
  `min_withdrawal_amount` DECIMAL(19, 8) NOT NULL DEFAULT 0.001 COMMENT 'minimum withdrawal amount',
